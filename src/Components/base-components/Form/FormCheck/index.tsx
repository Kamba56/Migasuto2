  ...
  return (
    <input
      ...
      className={twMerge([
        ...
        // Input type radio
        props.type == "radio" &&
          "shadow-lg border-slate-200 cursor-pointer focus:ring-4 focus:ring-offset-0 focus:ring-primary focus:ring-opacity-20 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50",
