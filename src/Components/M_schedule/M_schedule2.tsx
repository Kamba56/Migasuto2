...
const M_schedule2 = () => {
  return (
    <div className="w-[1100px] h-[132px] ml-[25px] bg-[#4880FF] rounded-[20px] flex items-center justify-between p-4">
      <div className="flex-1 flex items-center gap-[5px]">
        <div className="mr-[50px] mb-3">
        ...
        <div className="flex gap-[80px] justify-between items-start">
          <div className="flex flex-col mb-5 mt-[10px] mr-[80px] gap-[3px]">
          ...
          <div className="flex flex-col ml-[40px] mt-[10px] gap-[3px] ">
            <h1 className="text-[white]   font-[600] mb-[5px] text-[16px]">
