...
export default function SubscriptionPage() {
  ...
  return (
    <div className="inset-0 bg-[#ECF0FF] ">
      <div className="bg-[#ECF0FF] md:max-h-screen p-4 md:pt-[1.56em] md:px-[1.56em] overflow-hidden">
        ...
        <div className="flex flex-col items-center md:flex-row gap-8 md:gap-0 lg:gap-0 md:justify-center md:align-middle min-h-[53em] md:min-h-[15em]">
