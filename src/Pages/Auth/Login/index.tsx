        ...
        <article className="lg:w-1/2 flex flex-col gap-20 justify-between px-[12%] pt-20">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-row gap-0 p-1 bg-grey-10 rounded-lg">
              <div className="w-1/2">
                <Link to='/signup' className="flex justify-center w-full items-center gap-3 px-8 py-2 text-base font-medium cursor-pointer text-grey-20 bg-grey-10 rounded-lg">Signup</Link>
              </div>
              <div className="w-1/2">
                <Link to='/login' className="flex justify-center w-full items-center gap-3 px-8 py-2 text-base font-medium cursor-pointer text-white bg-blue-10 rounded-lg">Login</Link>
              </div>
            </div>
