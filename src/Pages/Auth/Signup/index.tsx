        ...
        <article className="bg-authbg bg-center bg-cover rounded-2xl py-28 px-[5%] flex flex-col gap-20 justify-between text-center lg:w-1/2 text-white">
          <div className="flex flex-col gap-3">
            ...
            <p className="font-medium text-2xl">
              We are dedicated to providing high-quality research and analysis
              to help our clients make informed decisions. We put our clients
              first in every decision we make, which is why we will always
              succeed in delivering first- class solutions to all our
              client&apos;s challenges.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="text-base w-[70%] self-center">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-row gap-0 p-1 bg-grey-10 rounded-lg">
              ...
              <div className="w-1/2">
                <Link
                  to="/login"
                  className="flex justify-center w-full items-center gap-3 px-8 py-2 text-base font-medium cursor-pointer text-grey-20 bg-grey-10 rounded-lg"
                >
                  Login
                </Link>
              </div>
            ...
            >
              ...
              <div className="w-full flex flex-col gap-2 relative">
                ...
                <div>
                  <Link
                    to=""
                    className="text-grey-20 text-xs absolute underline capitalize top-1 right-0"
                  >
                    forgot password?
                  </Link>
                </div>
              ...
              <BlueButton btnName={"Create Account"} type="submit" />

              <div className="flex items-center justify-center text-grey-20 before:absolute relative after:absolute before:w-1/3 before:h-[1px] before:bg-grey-20  font-medium before:right-8 after:w-1/3 after:h-[1px] after:bg-grey-20 after:left-8 opacity-30">
                OR
              </div>
